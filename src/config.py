...
RAW_DATA_DIR = DATA_DIR / "01-result"
PROCESSED_DATA_DIR = DATA_DIR / "02-result"
EDA_DATA_DIR = DATA_DIR / "03-result"
...
# Data retrieval endpoints (matching notebook 01_1)
...
# Parameters (matching notebook 01_1)
NB_TOP_TARGETS = 10  # Number of top targets to retrieve from Open Targets
